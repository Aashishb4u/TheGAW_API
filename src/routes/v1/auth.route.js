...
router.post('/product_order_form', validate(resendValidation.product_order_form), resendController.sendEmailToCustomer);
router.post('/careers', validate(resendValidation.careers), resendController.sendEmailToCustomer);
